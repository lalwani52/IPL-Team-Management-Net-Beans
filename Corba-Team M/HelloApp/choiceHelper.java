...
/**
* HelloApp/choiceHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from hello.idl
* Sunday, 4 February, 2018 2:20:36 AM IST
*/

abstract public class choiceHelper
{
  private static String  _id = "IDL:HelloApp/choice:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (HelloApp.choiceHelper.id (), "choice", __typeCode);
    }
    return __typeCode;
  }
